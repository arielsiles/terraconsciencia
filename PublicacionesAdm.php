...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="assets/CSS/stylePbAdm.css">
    ...
    <body>
        <a href="SubirPublicacion.php" class="edicionAdm">
        ...
        <div class="cuerpo">
            <br>    
            <h1 style="color:rgb(54, 73, 73)">&nbsp;&nbsp;Seguridad hídrica y alimentaria para estudiantes</h1>
            <br>
            ...
            <!---->
            <h1 style="color:rgb(54, 73, 73)">&nbsp;&nbsp;Seguridad hídrica y alimentaria para educadores</h1>
            <br>
            ...
            <!---->
            <h1 style="color:rgb(54, 73, 73)">&nbsp;&nbsp;Juventud Consciente</h1>
            <br>
