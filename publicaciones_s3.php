...
<h4 class="text-center mt-4 mb-4">Juventud Consciente</h4>
<div id="carouselJuventudControls" class="carousel slide" data-bs-ride="false">
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselJuventudControls" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselJuventudControls" data-bs-slide="next">
