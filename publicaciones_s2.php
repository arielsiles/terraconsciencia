...
$query = "SELECT dir_imagen, descripcion_pb, dir_pdf FROM seccionpb2 order by id desc ";
...
<h4 class="text-center mt-4 mb-4">Seguridad hídrica y alimentaria para educadores</h4>
<div id="carouselEducatorsControls" class="carousel slide" data-bs-ride="false">
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#carouselEducatorsControls" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-hidden">Previous</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#carouselEducatorsControls" data-bs-slide="next">
