...
<html lang="es">
    ...
    <body>
        <a href="modificarAvion.php" class="edicionAdm">
        ...
        <div class="confir" id="fndCf">
            <div class="vent" id="vent">
                ...
                <div class="botonesCf">
                    <a class="btnConf" href="SinLogin.php">Sí</a>
        ...
        <div id="juego">
            <div id="end-menu">
                <h1>PERDISTE</h1>
                <p>Puntuacion: <span id="end-score"></span></p>
                <p>Mejor Puntuacion: <span id="best-score"></span></p>
                <button id="restart-button" class="fb">Reiniciar</button>
            </div>
            <div id="gg-menu">
                <h1>GANASTE!!!</h1>
                <p>Mejor Puntuacion: <span id="best-score">10</span></p>
                <button id="restart-button-gg" class="fb">Reiniciar</button>
            </div>
            <div id="game-container">
                <canvas width="500" height="500" id="game-canvas" class="canvas"></canvas>
                <div id="score-display">0</div>
            </div>
            <button id="startGame" class="fb">Iniciar Juego</button>
