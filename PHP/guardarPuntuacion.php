...
$contador = 0;
$query = "SELECT contadorPlb FROM usuarios WHERE id = '$usuarioId'";
$resultado = mysqli_query($conexion, $query);
$fila = mysqli_fetch_assoc($resultado);
$contador = $fila['contadorPlb'];
if ($contador > 0) {
    ...
    $consulta = "UPDATE usuarios SET contadorPlb = 1 , puntos = '$puntosTotales' WHERE id = '$usuarioId'";
    $resultado = mysqli_query($conexion, $consulta);
    if ($resultado) {
