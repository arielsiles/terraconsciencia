...
<html lang="es">
    ...
    <body>
        <a href="SubirNoticias.php" class="edicionAdm">
                    ...
                    <?php
                        include "PHP/conexionBe.php";
                            ...
                            while ($row = $result->fetch_assoc()){
                                ...
                                echo "<a href='DetalleNoticia.php?id=" . $row["id_noticia"] . "' class='title' style='display: flex;justify-content: space-between;' >" . $row['titulo_noticia'] . "<p>ID NOTICIA:".$row["id_noticia"]."</p></a>";
                                echo "</div>";
